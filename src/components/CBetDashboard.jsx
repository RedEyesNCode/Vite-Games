...
export const CBetDashboard = (props) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full bg-slate-900 overflow-hidden flex items-center justify-center">
       ...
       > 
      <div className=" flex-grow overflow-y-auto h-screen bg-cover bg-center" style={{ backgroundImage: `url(${dashboardbackground})` }}> {/* Main content container */}
      <ToastContainer />
      ...
      {isHomeFrame && !isOfferFrame && (
        ...
        <PiSpeakerHighFill color="white" className="w-[25px] h-[25px] m-1" />
        <div className="text-slate-500 font-bold text-[10px] font-sans">Download the APP and start playing games to make money</div>
        <TbMessage2Code color="white" className="w-[25px] h-[25px] m-1" />
        ...
        <img
            ...
            ></img>
            <div className="ml-1 text-white font-sans font-medium text-[14px]">Cards</div>
        </div>
        ...
        <img
            ...
            className='w-[26px] h-[26px]  justify-center items-center object-fit'
            ></img>
            <div className="ml-1 text-white font-sans font-medium text-[14px]">Slots</div>
        </div>
        ...
        <img
            ...
            className='w-[26px] h-[26px]  justify-center items-center object-fit'
            ></img>
            <div className="ml-1 text-white font-sans font-medium text-[14px]">Sports</div>
        </div>
        ...
        <img
            ...
            className='w-[26px] h-[26px]  justify-center items-center object-fit'
            ></img>
            <div className="ml-1 text-white font-sans font-medium text-[14px]">Fishing</div>
        </div>
        ...
        <img
            ...
            className='w-[26px] h-[26px]  justify-center items-center object-fit'
            ></img>
            <div className="ml-1 text-white font-sans font-medium text-[14px]">Blockchain</div>
        </div>
        ...
        <img
            ...
            className='w-[26px] h-[26px]  justify-center items-center object-fit'
            ></img>
            <div className="ml-1 text-white font-sans font-medium text-[14px]">Lottery</div>
        </div>
