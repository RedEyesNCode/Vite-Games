...
const CBetFooter = () => {
  return (
    ...
    <div className="mt-4 font-light text-sm w-[350px] text-center"> 
      ...
      {/* Copyright */}
      <div className="text-center mt-8 text-[11px] font-mono  rounded-xl text-yellow-500">
        Copyright © 2024 Redbet Incorporated. All rights reserved.
      </div>
    </footer>
  );
};

export default CBetFooter;
